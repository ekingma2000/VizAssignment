...
with open('winterOlympicsWomenCan - Sheet1.csv') as csvfile:
...
names='Gold: 123', 'Silver: 75', 'Bronze: 41'
...
plt.title("Overall Medals for Canadian Women")
plt.xlabel("Medals from 1948 - 2014")
plt.show()